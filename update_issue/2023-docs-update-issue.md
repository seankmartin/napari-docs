...
The napari plugin ecosystem and the content at [napari.org/plugins](https://napari.org/dev/plugins) have been growing rapidly, and it would be beneficial to reorganize the plugin documentation to improve navigation.
Here is a proposal for restructuring the existing plugin-related content and introducing new valuable information.
This layout has already been shared with @DragaDoncila and the initial round of feedback has been incorporated into this proposal.
Please add any suggestions or comments regarding this proposal - I'd love to hear your thoughts!
...
Additionally, it may help clarify the usage of plugin metadata by napari itself, its usage by the napari hub, and the overlap between them.
